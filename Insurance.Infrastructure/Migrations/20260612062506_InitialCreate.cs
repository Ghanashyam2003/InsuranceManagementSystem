        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Maximum = table.Column<decimal>(type: "decimal(18,2)", precision: 18, scale: 2, nullable: false),
                    CreatedBy = table.Column<int>(type: "int", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    ModifiedBy = table.Column<int>(type: "int", nullable: true),
                    ModifiedAt = table.Column<DateTime>(type: "datetime2", nullable: true)
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ProductBenefits_InsuranceProducts_ProductId",
                        column: x => x.ProductId,
                        principalTable: "InsuranceProducts",
                        principalColumn: "ProductId");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CustomerNominees", x => x.NomineeId);
                    table.ForeignKey(
                        name: "FK_CustomerNominees_Customers_CustomerId",
                        column: x => x.CustomerId,
                        principalTable: "Customers",
                        principalColumn: "CustomerId");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_HealthProfiles_Customers_CustomerId",
                        column: x => x.CustomerId,
                        principalTable: "Customers",
                        principalColumn: "CustomerId");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RiskCategory = table.Column<string>(type: "nvarchar(20)", maxLength: 20, nullable: true),
                    RiskLoadingPercentage = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    PolicyTenureYears = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_UnderwritingCases_Quotes_QuoteId",
                        column: x => x.QuoteId,
                        principalTable: "Quotes",
                        principalColumn: "QuoteId");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    KycId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    CustomerId = table.Column<int>(type: "int", nullable: false),
                    KycType = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "CustomerId");
                    table.ForeignKey(
                        name: "FK_CustomerKycs_Users_VerifiedBy",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Notifications_Auths_AuthId",
                        column: x => x.AuthId,
                        principalTable: "Auths",
                        principalColumn: "AuthId");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PolicyMembers", x => x.MemberId);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ClaimInvestigations", x => x.InvestigationId);
                    table.ForeignKey(
                        name: "FK_ClaimInvestigations_Claims_ClaimId",
                        column: x => x.ClaimId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SettlementStatus = table.Column<string>(type: "nvarchar(30)", maxLength: 30, nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ClaimSettlements", x => x.SettlementId);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ClaimInvestigations_ClaimId",
                table: "ClaimInvestigations",
                column: "ClaimId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ClaimSettlements_ClaimId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CustomerKycs_VerifiedBy",
                table: "CustomerKycs",
                column: "VerifiedBy");

            migrationBuilder.CreateIndex(
                name: "IX_CustomerNominees_CustomerId",
                table: "CustomerNominees",
                column: "CustomerId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_HealthProfiles_CustomerId",
                table: "HealthProfiles",
                column: "CustomerId",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_Notifications_AuthId",
                table: "Notifications",
                column: "AuthId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UnderwritingCases_QuoteId",
